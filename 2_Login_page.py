...
title=tk.Label(window,text="Enter ID Number:", fg="white", bg="orange", font="Times 15 bold")
title.place(x=50,y=150)

title=tk.Label(window,text="Enter User Name:", fg="white", bg="orange", font="Times 15 bold")
title.place(x=50,y=250)

title=tk.Label(window,text="Enter Password:", fg="white", bg="orange", font="Times 15 bold")
...
button_1=tk.Button(window,text="Log in Main Page",width=30,height=2,fg="orange",font=("Verdana","10","bold"))
